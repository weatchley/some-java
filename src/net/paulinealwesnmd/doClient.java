...
public class doClient extends HttpServlet {
  ...
  private String processRequest(HttpServletRequest request, HttpServletResponse response) {
    ...
    String lastSeenS = request.getParameter("lastseen");
    java.util.Date lastSeen = ((lastSeenS != null && lastSeenS.compareTo("   ") > 0) ? Utils.toDate(lastSeenS) : null);
    ...
    nextScript = (nextScript != null && nextScript.compareTo(" ") > 0) ? nextScript : "clients.jsp";
...
//        System.out.println(outLine);
  ...
  private void generateResponse(String outLine, String command, String nextScript, boolean success, HttpServletResponse response)
    ...
    out.println("<title>Clients</title>");
    out.println("</head>");
